...
const stands = {
    "the-world": {
        ...
        skills: `
            ...
            <p><strong>特殊技能：</strong>强化连打[连打持续期间蹲下再使用普攻触发]，手刀[时停绕后/时停突袭触发，将普攻短暂替换为手刀]，时停瞬移突袭[骑在银色子弹上时使用三技能]，强化手刀[蹲下使用手刀]，强化飞刀[当背包有3~5把以上的飞刀时普攻第二段二技能替换为强化飞刀]，上挑[普攻第三段将二技能短暂替换为上挑]，召唤银色子弹，HHA[使用上挑打中敌人的瞬间按下时间暂停触发]</p>
